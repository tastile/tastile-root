...
- root は cross-repo shell / shared contract を所有し、child repository の source state を root Git state から推測しない。
- `docs/HARNESS.md` / ADR / child AGENTS の authority を維持する。
- cross-repo verification evidence は各 child commit identity と対応付ける。
